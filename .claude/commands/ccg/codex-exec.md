...
```
Bash({
  command: "C:/Users/saite/.claude/bin/codeagent-wrapper.exe --backend codex - \"{{WORKDIR}}\" <<'EXEC_EOF'
<TASK>
<指令内容>
</TASK>
EXEC_EOF",
...
```
Bash({
  command: "C:/Users/saite/.claude/bin/codeagent-wrapper.exe --backend codex resume <SESSION_ID> - \"{{WORKDIR}}\" <<'EXEC_EOF'
<TASK>
<指令内容>
</TASK>
EXEC_EOF",
...
```
Bash({
  command: "C:/Users/saite/.claude/bin/codeagent-wrapper.exe --backend <codex|gemini> {{GEMINI_MODEL_FLAG}}- \"{{WORKDIR}}\" <<'REVIEW_EOF'
ROLE_FILE: <角色提示词路径>
<TASK>
...
```
Bash({
  command: "C:/Users/saite/.claude/bin/codeagent-wrapper.exe --backend codex resume <CODEX_SESSION> - \"{{WORKDIR}}\" <<'EXEC_EOF'
<TASK>
...
```
Bash({
  command: "C:/Users/saite/.claude/bin/codeagent-wrapper.exe --backend codex resume <CODEX_EXEC_SESSION> - \"{{WORKDIR}}\" <<'FIXEOF'
<TASK>
