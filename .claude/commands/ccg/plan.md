...
**调用 `mcp__fast-context__fast_context_search` 工具**：
...
1. **Codex 后端分析**：
   - ROLE_FILE: `C:/Users/saite/.claude/.ccg/prompts/codex/analyzer.md`
...
1. **Codex 计划草案**（后端权威）：
   - ROLE_FILE: `C:/Users/saite/.claude/.ccg/prompts/codex/architect.md`
