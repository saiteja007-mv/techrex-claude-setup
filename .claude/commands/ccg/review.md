...
| 模型 | 提示词 |
|------|--------|
| Codex | `C:/Users/saite/.claude/.ccg/prompts/codex/reviewer.md` |
| Gemini | `C:/Users/saite/.claude/.ccg/prompts/gemini/reviewer.md` |
...
调用 `mcp__fast-context__fast_context_search` 获取相关上下文。
