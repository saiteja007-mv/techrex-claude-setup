...
| 模型 | 提示词 |
|------|--------|
| Codex | `C:/Users/saite/.claude/.ccg/prompts/codex/analyzer.md` |
| Gemini | `C:/Users/saite/.claude/.ccg/prompts/gemini/analyzer.md` |
...
1. 调用 `mcp__fast-context__fast_context_search` 检索相关代码
2. 识别分析范围和关键组件
3. 列出已知约束和假设
